...
class mouseDJ:
    ...
    def start(self, play_time=0):
        if (type(play_time) != int) or (play_time < 0):
        ...
        #スレッド設定
        self.thread_1_flag = True
        self.thread_2_flag = True
        self.thread_3_flag = True
